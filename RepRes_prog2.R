...
# The rest of cathegories will be consither togheter as Uncathegorized

StormData[ (grep( pattern = "Summary" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "None" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Monthly" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "(.*)Urban(.*)" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Apache" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Southeast" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Month" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Year" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Marine (.*)" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Other" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Failure" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "(.*)Record(.*)" , x = StormData$EVTYPE, ignore.case = TRUE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "HIGH" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "NORTHERN LIGHTS" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "REMNANTS OF FLOYD" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "DAM BREAK" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "No Severe Weather" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "Metro Storm, May 26" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "HEAVY MIX" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "VOG" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "MILD PATTERN" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")
StormData[ (grep( pattern = "EXCESSIVE" , x = StormData$EVTYPE, ignore.case = FALSE) ), "EVTYPE"] <- c("Uncathegorized")

# Now we remove invalid data before we can remove the "?" mark
StormData <- StormData[!is.na(StormData[,"EVTYPE"]) , ]
StormData[ StormData$EVTYPE == "?" , "EVTYPE"] <- c("Uncathegorized")
...
StormData_Heath<- StormData[complete.cases(StormData[,c("EVTYPE","FATALITIES","INJURIES")]),c("EVTYPE","FATALITIES","INJURIES")]
...
StormData_HeathSUM <- arrange(summarise ( group_by( StormData_Heath , EVTYPE ), SUM = sum( FATALITIES + INJURIES) ) , desc(SUM))

# The worst event type, in terms of human heath, is the maximum value of this dataframe

StormData_HeathSUM[ StormData_HeathSUM$SUM == max(StormData_HeathSUM$SUM) , ]

# The result is:

Evtype_Health <- as.character(StormData_HeathSUM[ StormData_HeathSUM$SUM == max(StormData_HeathSUM$SUM) , 1])
Evtype_HealthValue <- round( as.numeric(StormData_HeathSUM[ StormData_HeathSUM$SUM == max(StormData_HeathSUM$SUM) , 2]) , 2)
...
StormData_HeathGraph <- StormData_HeathSUM
StormData_HeathGraph[ StormData_HeathGraph$SUM < (sum(StormData_HeathGraph$SUM) * 0.01), "EVTYPE"] <- "Others"
StormData_HeathGraph <- arrange( summarise( group_by( StormData_HeathGraph, EVTYPE), SUM = sum( SUM) ) , desc(SUM))

# Generate graph
linch <-  max(strwidth(StormData_HeathGraph$EVTYPE, "inch")+0.4, na.rm = TRUE)
par(mai=c(1.02,linch,0.82,0.42))

graph1 <- barplot(height = StormData_HeathGraph$SUM, names.arg = StormData_HeathGraph$EVTYPE ,horiz=TRUE, main = "Deads by Atmospheric Event since 1950", xlab = "Recorded diseases since 1950", col=rainbow(12), las=1)
print(graph1)
...
StormData_Econ <- StormData_Econ [ , c("EVTYPE","PROPDMG","PROPDMGEXP","CROPDMG","CROPDMGEXP" ) ]
...
StormData_Econ[ (grep( pattern = "[Hh]" , x = StormData_Econ$PROPDMGEXP, ignore.case = TRUE) ), "PROPDMGEXP"] <- as.numeric(0)
StormData_Econ[ StormData_Econ$PROPDMGEXP == "+", "PROPDMGEXP"] <- as.numeric(1)
StormData_Econ[ StormData_Econ$PROPDMGEXP == "-", "PROPDMGEXP"] <- as.numeric(1)
StormData_Econ[ (grep( pattern = "[0-9]" , x = StormData_Econ$PROPDMGEXP, ignore.case = TRUE) ), "PROPDMGEXP"] <- as.numeric(1)
StormData_Econ[ (grep( pattern = "[Kk]" , x = StormData_Econ$PROPDMGEXP, ignore.case = TRUE) ), "PROPDMGEXP"] <- as.numeric(10^3)
StormData_Econ[ (grep( pattern = "[Mm]" , x = StormData_Econ$PROPDMGEXP, ignore.case = TRUE) ), "PROPDMGEXP"] <- as.numeric(10^6)
StormData_Econ[ (grep( pattern = "[Bb]" , x = StormData_Econ$PROPDMGEXP, ignore.case = TRUE) ), "PROPDMGEXP"] <- as.numeric(10^9)
StormData_Econ[ StormData_Econ$PROPDMGEXP == "?", "PROPDMGEXP"] <- as.numeric(0)
...
# List of exponents
List<-unique(StormData_Econ$CROPDMGEXP)
View(List)

StormData_Econ[ (grep( pattern = "[Hh]" , x = StormData_Econ$CROPDMGEXP, ignore.case = TRUE) ), "CROPDMGEXP"] <- as.numeric(0)
StormData_Econ[ StormData_Econ$CROPDMGEXP == "+", "CROPDMGEXP"] <- as.numeric(1)
StormData_Econ[ StormData_Econ$CROPDMGEXP == "-", "CROPDMGEXP"] <- as.numeric(1)
StormData_Econ[ (grep( pattern = "[0-9]" , x = StormData_Econ$CROPDMGEXP, ignore.case = TRUE) ), "CROPDMGEXP"] <- as.numeric(1)
StormData_Econ[ (grep( pattern = "[Kk]" , x = StormData_Econ$CROPDMGEXP, ignore.case = TRUE) ), "CROPDMGEXP"] <- as.numeric(10^3)
StormData_Econ[ (grep( pattern = "[Mm]" , x = StormData_Econ$CROPDMGEXP, ignore.case = TRUE) ), "CROPDMGEXP"] <- as.numeric(10^6)
StormData_Econ[ (grep( pattern = "[Bb]" , x = StormData_Econ$CROPDMGEXP, ignore.case = TRUE) ), "CROPDMGEXP"] <- as.numeric(10^9)
StormData_Econ[ StormData_Econ$CROPDMGEXP == "?", "CROPDMGEXP"] <- as.numeric(0)
...
StormData_Econ[is.na( StormData_Econ$PROPDMG) , "PROPDMG"] <- 0
StormData_Econ[is.na( StormData_Econ$PROPDMGEXP) , "PROPDMGEXP"] <- 0
StormData_Econ[is.na( StormData_Econ$CROPDMG) , "CROPDMG"] <- 0
StormData_Econ[is.na( StormData_Econ$CROPDMGEXP) , "CROPDMGEXP"] <- 0
...
graph2 <- barplot(height = StormData_EcoGraphTotal$Monetary, names.arg = StormData_EcoGraphTotal$EVTYPE , horiz=TRUE, main = "Total loss due to Atmospheric Events", xlab = "Loss in Billions of dollars", col=rainbow(14), las=1)
print(graph2)

## Graph2 : Value in billions of dollarsof Damaged Properties due to Atmospheric events.
# To reduce the categories I will merge all cathegories that represent less that 1% of the total deads.
...
graph2 <- barplot(height = StormData_EcoGraphProp$Properties, names.arg = StormData_EcoGraphProp$EVTYPE , horiz=TRUE, main = "Total loss due to Atmospheric Events", xlab = "Loss in Billions of dollars", col=rainbow(12), las=1)
...
graph3 <- barplot(height = StormData_EcoGraphCrop$Crop, names.arg = StormData_EcoGraphCrop$EVTYPE , horiz=TRUE, main = "Total loss due to Atmospheric Events", xlab = "Loss in Billions of dollars", col=rainbow(14), las=1)


linch <-  max(strwidth(StormData_EcoGraphProp$EVTYPE, "inch")+0.4, na.rm = TRUE)
par(mfrow=c(2,1), mai=c(1.02,linch,0.82,0.42))
barplot(height = StormData_EcoGraphProp$Properties, names.arg = StormData_EcoGraphProp$EVTYPE , horiz=TRUE, main = "Total loss due to Atmospheric Events", xlab = "Loss in Billions of dollars", col=rainbow(12), las=1)
barplot(height = StormData_EcoGraphCrop$Crop, names.arg = StormData_EcoGraphCrop$EVTYPE , horiz=TRUE, main = "Total loss due to Atmospheric Events", xlab = "Loss in Billions of dollars", col=rainbow(14), las=1)
